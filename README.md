...
GitHub Actions for `node` based repositories. It supports `pnpm`, `yarn`, and `npm` as package managers.
...
Lint will run pre-commit linters and eslint against the consumer repository, optionally checking out, and installing node, pnpm/yarn/npm and any other required tools with [action-setup-tools](https://github.com/open-turo/action-setup-tools).
